  ...
  return (
    <div className='flex items-center justify-between p-4 border border-gray-200 hover:border-gray-500 cst-transition'>
      <div className='flex flex-col self-stretch justify-between w-2/3'>
        ...
        <div>
          {options && options?.length > 0 && (
            <>
              ...
              >
                <option className='flex items-center justify-center w-full'>
                  -
                </option>
                {options.map(
                  ({
        ...
        <div className='flex items-start sm:items-center justify-start sm:justify-between w-full flex-col sm:flex-row'>
